...
urlpatterns = [
    path("<uuid:id>/create/<uuid:post_id>/<int:parent_comment_id>/", CreateCommentView.as_view(), name = 'create_comment'),
    path("<uuid:id>/create/<uuid:post_id>/", CreateCommentView.as_view(), name='create_comment'),
