...
from posts.views import ShowAllPostsView, ShowPrecisePostView, AddPostView, DeletePostView

urlpatterns = [
    path("posts/", ShowAllPostsView.as_view(), name = "show_all_user_posts" ),
    path("precise/<uuid:post_id>/", ShowPrecisePostView.as_view(), name = "show_precise_post"),
